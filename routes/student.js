...
const homePage = readFileSync('./app/students/index.html');
const fileCss = readFileSync('./app/students/css/style.css');
const fileJs = readFileSync('./app/students/js/script.js');
